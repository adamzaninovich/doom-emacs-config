...
(defun me/choose-random-banner (files)
  (me/make-banner-path (me/random-choice files)))

(defun me/make-banner-path (file)
...
(setq me/banner-list '("doom-blue.png"
                       "doom-2-blue.png"
                       "doom-guy.png"
                       "doom-grey.png"
                       "doom-2-grey.png"
...
(setq +doom-dashboard-banner-file (me/choose-random-banner me/banner-list))
